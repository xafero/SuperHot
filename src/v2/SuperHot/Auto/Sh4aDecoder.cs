...
{
	internal sealed class Sh4aDecoder : IDecoder
	{
		public Instruction? Decode(IByteReader reader, bool fail)
		{
			...
			if (d33E44A000000.Decode(n0, n1, n2, n3) is { } x6)
				return x6;
			if (d2A44A0000000.Decode(n0, n1, n2, n3) is { } x7)
				return x7;
			if (d44A000000000.Decode(n0, n1, n2, n3) is { } x8)
				return x8;
			if (d4A0000000000.Decode(n0, n1, n2, n3) is { } x9)
				return x9;
